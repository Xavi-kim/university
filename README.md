...
Система управления университетом на Spring Boot с PostgreSQL
...
- 📝 **Домашние задания** - создание и управление
- ✅ **Проверка работ** - оценка сданных заданий
- 👥 **Просмотр студентов** на своих курсах
- 💬 **Чат со студентами**
...
|------|-------|--------|-------------|
| **Профессор** | teacher@university.kz | admin123 | Создание курсов, ДЗ, оценки |
| **Студент** | asel@student.kz | 123456 | Запись на курсы, сдача ДЗ |
| **Админ** | admin@university.kz | admin123 | Полный доступ |
...
- **`БЫСТРЫЙ_СТАРТ_v2.md`** - Быстрый старт v2.0
